  ...
  return (
    <div className="space-y-6">
      <section className="rounded-lg border border-black/[.08] bg-white p-6 dark:border-white/[.145] dark:bg-black">
        <h1 className="text-3xl font-semibold tracking-tight">Split travel expenses. Settle up fast.</h1>
        <p className="mt-3 max-w-2xl text-base text-black/70 dark:text-zinc-300">
      ...
      <section className="grid gap-4 sm:grid-cols-3">
        <div className="rounded-lg border border-black/[.08] bg-white p-4 dark:border-white/[.145] dark:bg-black">
          <h2 className="text-sm font-semibold">Track expenses</h2>
          <p className="mt-2 text-sm text-black/60 dark:text-zinc-400">
            Add expenses with payers and shares.
          </p>
        </div>
        <div className="rounded-lg border border-black/[.08] bg-white p-4 dark:border-white/[.145] dark:bg-black">
          <h2 className="text-sm font-semibold">See balances</h2>
          <p className="mt-2 text-sm text-black/60 dark:text-zinc-400">
            Understand who owes and who gets back.
          </p>
        </div>
        <div className="rounded-lg border border-black/[.08] bg-white p-4 dark:border-white/[.145] dark:bg-black">
          <h2 className="text-sm font-semibold">Settle in fewer payments</h2>
          <p className="mt-2 text-sm text-black/60 dark:text-zinc-400">
